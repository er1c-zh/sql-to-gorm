// Code generated from ./antlr4_gen/MySqlParser.g4 by ANTLR 4.9. DO NOT EDIT.

package antlr4_gen // MySqlParser
...
func (s *BaseMySqlParserListener) EnterEmptyStatement(ctx *EmptyStatementContext) {}

// ExitEmptyStatement is called when production emptyStatement is exited.
func (s *BaseMySqlParserListener) ExitEmptyStatement(ctx *EmptyStatementContext) {}
...
// EnterPartitionComparision is called when production partitionComparision is entered.
func (s *BaseMySqlParserListener) EnterPartitionComparision(ctx *PartitionComparisionContext) {}

// ExitPartitionComparision is called when production partitionComparision is exited.
func (s *BaseMySqlParserListener) ExitPartitionComparision(ctx *PartitionComparisionContext) {}
