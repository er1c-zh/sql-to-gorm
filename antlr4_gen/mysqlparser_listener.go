...
type MySqlParserListener interface {
	...
	// EnterPartitionComparision is called when entering the partitionComparision production.
	EnterPartitionComparision(c *PartitionComparisionContext)
	...
	// ExitPartitionComparision is called when exiting the partitionComparision production.
	ExitPartitionComparision(c *PartitionComparisionContext)
